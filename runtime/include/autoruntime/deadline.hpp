...
class Deadline {
 public:
  ...
  [[nodiscard]] static Deadline At(TimePoint point) noexcept {
    return Deadline(false, point);
  }
 ...
 private:
  Deadline(bool infinite, TimePoint point) noexcept
      : infinite_(infinite), time_point_(point) {}
